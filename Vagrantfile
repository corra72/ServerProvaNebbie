...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "ubuntu/jammy64"  # ← Cambia da bionic64 a jammy64 (22.04)
  ...
  config.vm.provision "shell", inline: <<-SHELL
	...
	apt-get -qq install git php7.2-cli g++-12 apache2 make cmake libconfig++-dev lnav libsqlite3-dev libcurlpp-dev gdb libcurl4-openssl-dev
